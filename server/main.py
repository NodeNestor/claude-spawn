    ...
    "Spawn a new containerized Claude Code agent",
    {
        "properties": {
            ...
            "mcp_servers": {
                "type": "array",
                "items": {"type": "string"},
                "description": "MCP servers to enable: playwright, context7, filesystem, github, fetch, memory, postgres, sqlite. Defaults: playwright + context7. Pass 'none' to disable all, 'all' for everything.",
            },
            "api_key": {
                "type": "string",
